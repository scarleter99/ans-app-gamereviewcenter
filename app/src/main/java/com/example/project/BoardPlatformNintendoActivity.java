...
public class BoardPlatformNintendoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_search.setOnClickListener(new View.OnClickListener(){// 검색 버튼 클릭 시
            public void onClick(View v) {
                search = SPN_nintendo.getSelectedItem().toString();
                keyword = et_search.getText().toString();
                getAllData("nintendo", 2);
            }
        });
        ...
        firstButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (comment.equals("업로드된 글이 없습니다.")){
                    ...
                    Intent intent = new Intent(getApplicationContext(), BoardPlatformNintendoActivity.class);
        ...
        switch (what) {
            ...
            case 2://검색화면
                for (int i = 0; i< theButton.size();i++){
                    ...
                    layout_nintendo.removeView(button);
                }
                for (int i = 0; i< theButton.size();i++){
                    theButton.remove(0);
                }
    ...
    protected void putDatas(String string) { //누른 버튼의 데이터를 저장
        ...
        editor.clear();
        editor.putString("nintendo", string);
        editor.apply();
    }
