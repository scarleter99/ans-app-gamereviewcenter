...
public class BoardPlatformEtcActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_search.setOnClickListener(new View.OnClickListener(){// 검색 버튼 클릭 시
            public void onClick(View v) {
                search = SPN_etc.getSelectedItem().toString();
        ...
        firstButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (comment.equals("업로드된 글이 없습니다.")){
                    ...
                    Intent intent = new Intent(getApplicationContext(), BoardPlatformEtcActivity.class);
