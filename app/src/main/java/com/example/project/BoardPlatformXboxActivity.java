...
public class BoardPlatformXboxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstButton = (Button) findViewById(R.id.btn_samplereview_xbox);
        layout_xbox = (LinearLayout) findViewById(R.id.layout_xbox);
        ...
        btn_search.setOnClickListener(new View.OnClickListener(){// 검색 버튼 클릭 시
            public void onClick(View v) {
                search = SPN_xbox.getSelectedItem().toString();
        ...
        firstButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (comment.equals("업로드된 글이 없습니다.")){
                    ...
                    Intent intent = new Intent(getApplicationContext(), BoardPlatformXboxActivity.class);
